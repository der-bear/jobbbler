...
describe("WebMCP explanation", () => {
  it("presents the agentic-web value in mainstream language without inventing an embedded agent", () => {
    ...
    expect(markup).toContain("Tell your agent the outcome. It handles the steps.");
    ...
    expect(markup).toContain("Full demo prompt");
    ...
    expect(markup).toContain("See the agent at work.");
