...
- [WebMCP capability matrix](architecture/webmcp-capability-matrix.md)
- [WebMCP evaluation evidence](architecture/webmcp-evals.md)
- [Agent authorization and data consent](architecture/agent-authorization-and-consent.md)
- [Realtime Agent Activity](architecture/realtime-agent-activity.md)
- [Source ingestion and governance](architecture/source-ingestion.md)
- [Product experience](design/product-experience.md)
- [Design and accessibility QA](design/qa.md)
