...
| ---- | ------------------------------------------------------------------------ | -------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| 1    | Open the production URL from the external agent client                   | User request and URL remain legible                | Establish agent client, then the full Jobbbler search page                       | Route tools are discovered                                                      |
...
| 4    | Open one role and add it to comparison                                   | Role title, source, freshness, unknowns            | Document-style role content, then comparison action                              | Route tool set changes with navigation                                          |
