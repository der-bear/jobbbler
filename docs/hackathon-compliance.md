...
| WebMCP-powered web app                                    | Imperative `document.modelContext.registerTool` integration with the same 26 tools on every route, shared UI state, activity feedback, and lifecycle tests         | Live tools discovered and called   |
